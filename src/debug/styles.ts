...
.a11y-debug-sidebar[data-theme="dark"] .a11y-panel-issue-warning {
  color: #facc15;
}
.a11y-panel-issues-toggle {
  display: block;
  border: none;
  background: transparent;
  color: #dc2626;
...
.a11y-panel-issues-toggle:hover {
  opacity: 0.8;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-panel-issues-toggle {
  color: #f87171;
}
...
.a11y-panel-row-warning .a11y-panel-tag {
  color: #a16207;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-panel-row-warning {
  background: #3b2f11;
  border-left-color: #facc15;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-panel-row-warning .a11y-panel-tag {
  color: #facc15;
}
...
.a11y-score-green { color: #15803d; }
.a11y-score-yellow { color: #a16207; }
...
.a11y-audit-summary-scope {
  display: block;
  font-size: 10px;
  color: var(--a11y-sidebar-text-muted);
  margin-bottom: 4px;
}
.a11y-audit-summary-counts {
  display: flex;
  gap: 8px;
  font-size: 12px;
  font-weight: 600;
}
.a11y-audit-pass-count {
  color: #15803d;
}
.a11y-audit-fail-count {
  color: #dc2626;
}
.a11y-audit-warn-count {
  color: #a16207;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-audit-pass-count {
  color: #4ade80;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-audit-fail-count {
  color: #f87171;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-audit-warn-count {
  color: #facc15;
}
.a11y-audit-criterion {
  border: 1px solid var(--a11y-sidebar-border);
  border-radius: 4px;
  margin-bottom: 4px;
  overflow: hidden;
}
.a11y-audit-criterion-fail {
  border-left: 3px solid #dc2626;
}
.a11y-audit-criterion-pass {
  border-left: 3px solid #15803d;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-audit-criterion-fail {
  border-left-color: #f87171;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-audit-criterion-pass {
  border-left-color: #4ade80;
}
.a11y-audit-criterion-header {
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 4px 8px;
...
.a11y-audit-criterion-header:hover {
  background: var(--a11y-sidebar-icon-hover-bg);
}
.a11y-audit-criterion-status {
  font-size: 9px;
  font-weight: 700;
  padding: 1px 4px;
  border-radius: 2px;
...
.a11y-audit-status-pass {
  background: #dcfce7;
  color: #15803d;
}
.a11y-audit-status-fail {
  background: #fef2f2;
  color: #dc2626;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-audit-status-pass {
  background: #14532d;
  color: #4ade80;
}
.a11y-debug-sidebar[data-theme="dark"] .a11y-audit-status-fail {
  background: #3b1111;
  color: #f87171;
}
.a11y-audit-criterion-id {
  font-family: monospace;
  font-size: 10px;
  font-weight: 600;
  flex-shrink: 0;
}
.a11y-audit-criterion-name {
  flex: 1;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}
.a11y-audit-criterion-level {
  color: var(--a11y-sidebar-text-muted);
  font-size: 10px;
  flex-shrink: 0;
}
.a11y-audit-criterion-count {
  color: var(--a11y-sidebar-text-muted);
  font-size: 10px;
  flex-shrink: 0;
}
